...
4. (optional) Scripts to reproduce Figures 4 and 5 of the main manuscript can be found [here](https://github.com/Timh37/TimingAFs/blob/main/plotting). The input timing projections can be downloaded from our [Zenodo repository]().
